...
try:
    ...
    # -----------------------------------------------------------------
    # Prior year vs current year trend comparison
    # -----------------------------------------------------------------
...
# ---------------------------------------------------------------------------
st.markdown("---")
st.caption(f"Questions or issues? Contact {SUPPORT_EMAIL}")# Credentials: st.secrets first, .env fallback for local dev.
# The optional "environment" key ("sandbox" | "production") selects which
# QBO endpoints this deployment talks to - no code edits between environments.
# ---------------------------------------------------------------------------
from streamlit.errors import StreamlitSecretNotFoundError
